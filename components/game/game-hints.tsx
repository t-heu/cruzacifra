        ...
        {palavrasPosicionadas.map((palavra, index) => (
          <div key={index} className="bg-gray-700 border border-gray-600 rounded-lg p-4">
                ...
                <div>
                  ...
                  {dicasReveladas.includes(index) && (
                    <div className="text-sm text-gray-400">
                      ...
                      <span className="text-purple-400">Dificuldade:</span>{" "}
                      <span
              ...
              <div className="flex gap-2">
                ...
                {dicasReveladas.includes(index) && palavra.curiosidade && (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg font-medium bg-purple-600 text-white hover:bg-purple-700 border border-purple-500 transition-colors"
                  >
            ...
            {mostrarCuriosidade === index && palavra.curiosidade && (
              <div className="bg-purple-900/30 border border-purple-700 rounded-lg p-4 mt-3">
                <div className="flex gap-3">
                  <HelpCircle className="w-5 h-5 text-purple-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-medium text-purple-300 mb-1">Você sabia?</h4>
                    <p className="text-purple-200 text-sm leading-relaxed">{palavra.curiosidade}</p>
                  </div>
                </div>
              </div>
            )}
